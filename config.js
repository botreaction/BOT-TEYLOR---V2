...
async function loadConfig() {
    try {
        ...
        /** Oᴡɴᴇʀ number  **/
        global.owner = [
            ["6289688206739", "️𝑾𝒖𝒅𝒚𝒔𝒐𝒇𝒕 - 𝑶𝒘𝒏𝒆𝒓", true]
        ];
        global.mods = ["6289688206739"];
        global.prems = ["6289688206739"];
        ...
        global.webs = "https://wa.me/6289688206739";
        global.gcwangsaf = "https://chat.whatsapp.com/HL8oaxQMOFkChPd1UbkgRK";

        /** Donasi  **/
        global.saweria = "https://saweria.com/wudysoft";
        global.dana = "6289688206739";
        global.pulsa = "6289688206739";
        global.trakteer = "https://trakteer.id/wudysoft";
        global.paypal = "wudysoft@mail.com";
        global.gopay = "6289688206739";
        global.pdana = "6289688206739";
        global.povo = "6289688206739";
        global.pgopay = "what.sagan@gmail.com";
...
function businessOwnerJid() {
    return pickRandom([pickRandom([global.nomorown, "0", "6289688206739", "6288906250517", "6282195322106", "6281119568305", "6281282722861", "6282112790446"]) + "@s.whatsapp.net"]);
}